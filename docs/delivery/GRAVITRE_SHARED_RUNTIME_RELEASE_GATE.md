...
Cesar: bypass remaining human testing until the end; move to 3.0. Implemented 3.0-H entity stamp + 3.0-I spoken yes-wait hold. Spoken HTTP traces **PASS** on Railway `19b3e014` (`SPOKEN_HTTP_NOT_VOICE_C`). Historical CI `35622991537` on `6d563e3d` stays FAIL; current-tip CI `35639657057` SUCCESS. 3.0-H live unique bind **NOT RUN**.
