...
**Current focus:** Tier 4 marketplace scale — STA-96 ✅, Connect v2 sample ✅ (`/samples/stripe-connect`, `docs/samples/stripe-connect-v2.md`), next **STA-97** certified partner program.
