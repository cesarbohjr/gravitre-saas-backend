...
_BUILTIN_ACTION_SCOPES: dict[str, list[str]] = {
    ...
    "hubspot.lists.get": ["hubspot:lists:read", "hubspot:lists:write", "hubspot:*"],
    ...
    "connectwise.companies.list": ["connectwise:company:read", "connectwise:*"],
    "connectwise.tickets.create": ["connectwise:service:tickets:write", "connectwise:*"],
    "hubspot.campaigns.list": ["hubspot:marketing-email:read", "hubspot:*"],
    "hubspot.campaigns.update": ["hubspot:marketing-email:write", "hubspot:*"],
    ...
    "github.actions.dispatch": ["github:actions:write", "github:*"],
    "github.pulls.merge": ["github:pulls:write", "github:*"],
    "github.releases.create": ["github:releases:write", "github:*"],
    "github.issues.list": ["github:issues:read", "github:*"],
    "github.pulls.get": ["github:pulls:read", "github:*"],
    "github.pulls.close": ["github:pulls:write", "github:*"],
    ...
    "googleads.campaigns.list": ["googleads:read", "google_ads:*", "googleads:*"],
    "googleads.campaigns.get": ["googleads:read", "google_ads:*", "googleads:*"],
    "googleads.ad_groups.list": ["googleads:read", "google_ads:*", "googleads:*"],
    "googleads.reports.performance": ["googleads:read", "google_ads:*", "googleads:*"],
    "googleads.keywords.list": ["googleads:read", "google_ads:*", "googleads:*"],
    "googleads.campaigns.update_budget": ["googleads:write", "google_ads:*", "googleads:*"],
