...
**Assignments** (`/assignments`) track units of work delegated to people, agents, or the AI Operator — distinct from **Runs**, which record workflow execution history.
...
- Delegate follow-ups from the AI Operator without building a full workflow
