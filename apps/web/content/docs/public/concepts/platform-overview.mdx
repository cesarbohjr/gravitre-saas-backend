...
GIBE learns only from **verified org signals** (chat queries, workflow runs, promoted memories). Predictions and promotions stay **advisory** until you act. See [GIBE — Learning](/docs/guides/how-to/org-learning).
...
- Gravitre AI (Execute mode) — `/api/operator/*`
- Gravitre AI (Chat mode) — `/api/assistant/*`
