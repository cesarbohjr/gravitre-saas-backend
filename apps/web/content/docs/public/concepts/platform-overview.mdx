...
| Surface | Route | Role |
|---------|-------|------|
| Command Center | `/command-center` | Delegate tracked work with action plans and async jobs |
| Workspace Chat | `/assistant` | Multi-turn chat, tools, and daily briefings |
...
```text
You describe a goal (Command Center, Goal, or Workflow trigger)
