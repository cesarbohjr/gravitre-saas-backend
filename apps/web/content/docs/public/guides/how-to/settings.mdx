...
Set workspace-wide model defaults — distinct from the **AI Models** registry at `/models`.

1. Open **Settings → AI Models**
2. **Workspace default** — Auto (recommended) or explicit model
3. **Command Center default** — analysis and plan generation
...
See [AI Models overview](/docs/concepts/ai-models) for deploy/predict on Command plan.
