...
6. Attach run to **Gravitre AI (Execute mode)** context for a proposed fix plan
...
- **Gravitre AI (Execute mode)** — attach run context: `/api/operator/context/run/{id}`
- **Universal Search** — find runs by natural language (`/search`)
