...
**Connectors** link Gravitre to external SaaS tools — CRM, support, dev platforms, finance, Google Workspace, email, and more. Workflows, agents, **Command Center**, and Marketplace assets invoke Connector actions only when the integration is **connected**, **healthy**, and authorized in the active **Environment**.
...
3. **Command Center** — context packs load connector health and related workflows
...
Debug a Connector from **Command Center** by attaching **Connector context**:
...
- [Configure Enterprise integration health](/docs/guides/how-to/enterprise#integration-health-command-center)
