...
const ROUTER_SYSTEM_PROMPT = [
  ...
  "- execute: the user wants Gravitre to DO operational work — fix/debug/retry/run/deploy/sync an existing workflow, connector, or incident. NOT for open-ended 'create an agent' setup.",
  "- chat: the user wants a conversational answer OR a Manus-like operator dialogue — questions, explanations, brainstorming, summaries, how-to, daily briefings, advice, AND creating/building agents or workflows step-by-step (confirm name, role, connectors, then act).",
  ...
  "",
  "Critical rules:",
  "- 'create/build/make/set up ... agent/workflow' => chat (conversational operator — ask follow-ups, confirm, then create).",
  "- 'fix/debug/retry failed sync/run workflow now' => execute.",
  "- 'find/show/list/open/locate the ...' or 'where is my ...' => find.",
  "- 'how/why/what/explain ...' without action verbs => chat.",
  "- Never classify agent or workflow creation as execute — even if the user says 'for me'.",
  "",
  "Examples:",
  "- 'create a new agent for me' => chat",
  "- 'build a HubSpot sync workflow' => chat",
