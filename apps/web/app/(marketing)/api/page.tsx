        ...
        <div className="mx-auto max-w-5xl">
          <div className="grid gap-8 lg:grid-cols-2">
            <motion.div
              ...
              viewport={{ once: true }}
              className="p-8 rounded-2xl border border-border bg-gradient-to-br from-purple-50 to-white"
            >
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              className="p-8 rounded-2xl border border-border bg-gradient-to-br from-amber-50 to-white"
            >
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Link
                href="/docs/api/quickstart"
                className="inline-flex items-center gap-2 rounded-full border border-border bg-card px-8 py-3 text-sm font-medium text-foreground hover:bg-muted/50 transition-colors"
              >
