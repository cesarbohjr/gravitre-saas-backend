...
const releases = [
  ...
  { version: "2.3.2", date: "March 28, 2026", title: "Security Enhancements", description: "SOC 2 Type II certification achieved, plus new security features for enterprise customers.", type: "security", highlights: ["SOC 2 Type II certification", "Enhanced audit logging", "IP allowlisting for API access", "Session management improvements"] },
