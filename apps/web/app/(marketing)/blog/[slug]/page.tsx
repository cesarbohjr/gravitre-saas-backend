...
function AuthorAvatar({ name, className = "" }: { name: string; className?: string }) {
  ...
  return (
    <span
      aria-hidden
      className={`grid place-items-center rounded-full bg-emerald-600 font-semibold text-white ${className}`}
    >
      {initials}
    </span>
  )
      ...
      <article className="px-6 pb-16 pt-28 lg:pt-32">
        <div className="mx-auto max-w-3xl">
          ...
          <header>
            ...
            <p className="mt-5 text-pretty text-lg leading-relaxed text-zinc-600">{post.excerpt}</p>

            <div className="mt-6 flex flex-wrap items-center gap-4 border-b border-zinc-200 pb-8">
              <AuthorAvatar name={post.author.name} className="h-11 w-11 text-sm" />
              <div className="mr-auto">
                <div className="text-sm font-medium text-zinc-900">{post.author.name}</div>
          ...
          >
            <h2 className="text-sm font-semibold uppercase tracking-wider text-emerald-700">Key takeaways</h2>
          ...
          <section className="mt-16 rounded-2xl border border-zinc-200 bg-zinc-50 p-8 text-center">
            <h2 className="text-pretty text-xl font-semibold text-zinc-900">
            ...
            <Link
              href="/get-started"
              className="mt-6 inline-flex items-center gap-2 rounded-full bg-emerald-600 px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-emerald-500"
            >
