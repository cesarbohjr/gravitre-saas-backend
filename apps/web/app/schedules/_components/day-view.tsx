 ...
 *
 * Outer chrome matches Month/Week (`bg-muted/30` + padding + shared board height)
 * so switching scopes never changes the board footprint.
 */
export function DayView({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden rounded-xl border border-border/60 bg-card",
          isToday && "border-primary/40 ring-1 ring-primary/20",
        )}
      >
        <div className="min-h-0 min-w-0 flex-1 overflow-y-auto">
          <div className="relative flex w-full" style={{ minHeight: gridHeight, height: gridHeight }}>
            {/* Time gutter */}
