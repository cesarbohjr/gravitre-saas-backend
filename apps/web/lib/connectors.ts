...
const CATALOG_ENTRIES: CatalogConnectorEntry[] = [
  ...
  { type: "Ahrefs", vendorKey: "ahrefs", description: "BYO Ahrefs API — domain rating, organic keywords, and backlinks; never uses a shared Gravitree key", authType: "apiKey", credentialModel: "api_key", category: "CRM / Marketing", shipped: true, authMode: "byo_required" },
