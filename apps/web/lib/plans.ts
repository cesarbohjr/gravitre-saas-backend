...
/** Customer-facing plan price — always the current marketing / catalog list price. */
export function formatMarketingPlanPriceLabel(
  plan: Plan,
  interval: BillingInterval = "monthly",
): string {
  return formatPlanPrice(plan, interval)
}
