...
import { HeroBrainFlow } from "./hero-brain-flow"
import { ProductPreview } from "./product-preview"

/**
 * Design Pass 3 B2 — Agenforce hero composition, bold Gravitre brand + one-brain message.
 */
...
export function HeroParallax() {
  ...
  return (
    ...
    >
      ...
      <MarketingSpotlight tone="balanced" interactive className="opacity-80" />
      ...
      >
        <div className="mx-auto max-w-4xl text-center">
          <motion.p
            ...
            className="text-sm font-bold uppercase tracking-[0.32em] text-primary"
          >
          ...
          <motion.h1
            ...
            className="mt-6 text-[2.6rem] font-bold leading-[1.05] tracking-[-0.04em] text-foreground sm:text-6xl lg:text-[4.75rem]"
          >
            <span className="block">{MARKETING_COPY.hero.headline[0]}</span>
            <span className="mt-1 block text-primary">{MARKETING_COPY.hero.headline[1]}</span>
          </motion.h1>
          ...
          >
            <Link
              href="/get-started"
              className="group relative inline-flex items-center gap-2 overflow-hidden rounded-full bg-primary px-8 py-4 text-base font-semibold text-primary-foreground shadow-[var(--g-glow-operational)] transition-all duration-[var(--g-duration-micro)] hover:opacity-95 active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
            >
            ...
            <Link
              href="/features"
              className="group inline-flex items-center gap-2 rounded-full border border-border bg-card/60 px-8 py-4 text-base font-semibold text-foreground shadow-[var(--g-shadow-surface)] backdrop-blur-md transition-all duration-[var(--g-duration-micro)] hover:border-primary/40 hover:bg-card active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
            >
              <Play strokeWidth={2} className="h-5 w-5 fill-foreground" />
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.85, delay: reduced ? 0 : 0.28, ease }}
        ...
        <motion.div
          initial={reduced ? false : { opacity: 0, y: 36 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.85, delay: reduced ? 0 : 0.4, ease }}
