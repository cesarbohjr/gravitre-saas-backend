...
const CATEGORY_DESCRIPTIONS: Record<string, string> = {
  ...
  "How-to Guides": "Task-focused walkthroughs — Gravitre AI, GIBE, workflows, connectors.",
  Guides: "Task-focused walkthroughs — Gravitre AI, GIBE, workflows, connectors.",
