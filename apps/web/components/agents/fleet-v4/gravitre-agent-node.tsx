...
/** Graph node — compact tile + dept + status (Relationships language). */
export function GravitreAgentNode({
  ...
  return (
    <button
      ...
      className={cn(
        "w-[188px] rounded-[var(--np-radius-md)] border border-divide bg-[color:var(--g-surface-1)] px-3 py-2 text-left shadow-[var(--np-shadow)] transition-shadow",
