...
def main() -> int:
    ...
    if report["verdict"] == "BLOCKED":
        # Env/fixture gap — not a live PASS. Exit 2 keeps dashboards from reading this as green.
        # Local mapper may still be correct; that is mapper-only evidence, not live proof.
        print(
