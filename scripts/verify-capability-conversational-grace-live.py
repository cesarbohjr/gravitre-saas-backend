"""Live proof: Phase 4 conversational grace for capability-resolved writes."""
...
OUT = REPO / "docs" / "delivery" / "capability-conversational-grace-live.json"
BASE = os.environ.get(
    "BACKEND_URL",
...
def main() -> int:
    ...
    if secret and actor_id:
        try:
            resp = httpx.post(
                f"{BASE}/api/internal/ops/capability-conversational-grace-smoke",
