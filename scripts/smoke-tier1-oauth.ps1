...
$vendors = @(
    "hubspot", "salesforce", "slack", "jira", "zendesk", "microsoft365",
...
Write-Host ""
Write-Host "Tier 1 OAuth smoke" -ForegroundColor Cyan
Write-Host ""
...
$outPath = Join-Path (Split-Path -Parent $PSScriptRoot) "docs\delivery\tier1-oauth-smoke-latest.json"
$payload = @{
