...
if (-not $ClientId -or -not $ClientSecret) {
    ...
    Write-Host "3. Graph delegated: offline_access User.Read Mail.Read Mail.Send Calendars.ReadWrite Files.ReadWrite.All ChannelMessage.Send" -ForegroundColor Yellow
